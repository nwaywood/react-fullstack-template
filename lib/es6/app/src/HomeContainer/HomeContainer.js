...
function make() {
  ...
  newrecord[/* render */9] = (function (self) {
      ...
      return React.createElement("div", undefined, React.createElement("button", {
                    ...
                    }, Utils.textEl("Refresh")), match !== 0 ? React.createElement("h2", undefined, Utils.textEl("loading...")) : React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, Greeting.make(/* array */[])), ReasonReact.element(/* None */0, /* None */0, Home.make(self[/* state */4][/* posts */0], /* array */[]))));
    });
